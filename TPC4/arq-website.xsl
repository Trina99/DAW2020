...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="ARQELEM" mode="indice">
        <li>
            ...
            <a name="i{$i}"/>
<!--            <a href="http://localhost:777/arq/{$i}.html">-->
    ...
    <xsl:template match="ARQELEM">
        <xsl:variable name="i" select="count(preceding-sibling::*)+1"/>
        <xsl:result-document href="website/arq{$i}.html">
            <html>
                <head>
                    <title>
                        <xsl:value-of select="IDENTI"/>
                ...
                <body>
                    ...
                    <address>
                        [<a href="{$i -1}">Anterior</a>]
                        [<a href="index.html#i{$i}">Voltar à Página Inicial</a>]
                        [<a href="{$i +1}">Seguinte</a>]
                    </address>
                    <center>
                        <hr width="80%"/>
                    </center>
